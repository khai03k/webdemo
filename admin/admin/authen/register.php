                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="register_action.php" method="POST">
                                            <div class="form-floating mb-3">
                                                <input required class="form-control" type="text" name="UserName" placeholder="Enter your name" />
                                                <label>UserName</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input required class="form-control" type="email" name="UserEmail" placeholder="name@example.com" />
